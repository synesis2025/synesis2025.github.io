...
description: "Four takeaways from Karpathy's chat with Dwarkesh — the decade of agents, RL through a straw, and why coding LLMs still aren't reliable collaborators. Now with an enriched transcript at the bottom."
author: "synesis"
date: "2025-10-18"
...
![Thumbnail from the Dwarkesh interview. [Watch on YouTube](https://www.youtube.com/watch?v=lXUZvyajciY) or [read on Dwarkesh's site](https://www.dwarkesh.com/p/andrej-karpathy).](cover.jpg){fig-align="center"}

::: {.callout-tip}
**Update — May 19, 2026.** Andrej Karpathy [joined Anthropic](https://www.forbes.com/sites/aliciapark/2026/05/19/openai-cofounder-and-former-tesla-ai-leader-andrej-karpathy-joins-anthropic/) seven months after this interview, working on pre-training under team lead Nick Joseph and helping launch a new team focused on using Claude to develop Anthropic's models. He posted on X that "the next few years at the frontier of LLMs will be especially formative." Read the [Future of education](#ch-education) chapter below with that in mind: Karpathy describes Eureka there as the place where he can "a lot more uniquely add value than an incremental improvement in the frontier lab."
:::

Takeaways from Andrej Karpathy's recent chat with Dwarkesh Patel:

* He believes full-on [**AGI is still about a decade away**](#ch-agi-decade-away), and instead of declaring this is "the year of agents", it's more like this is the beginning of "the decade of agents". Don't expect a paradigm shift overnight.
    * Compare with [The 2028 Global Intelligence Crisis: Scenario and Rebuttal](/posts/20260502-2028-intelligence-crisis/) — Citrini's bullish two-year displacement scenario vs. Citadel Securities' rebuttal two days later, both reading the same signal differently.
    * And [Sutskever at NeurIPS 2024: Pre-Training Era Is Over](/posts/20241213-sutskever-pretraining-over/) — the precursor "what comes next" call ten months earlier.

* He thinks today's [**RL (reinforcement learning) "sucks supervision through a straw"**](#ch-rl-is-terrible) — rewarding or punishing an entire trajectory with a single number. "You've done all this work only to find at the end you get a single number… it's just stupid and crazy."
    * Karpathy says "I do see papers popping out that are trying to do this because it's obvious to everyone in the field." [Reflexion: Language Agents with Verbal Reinforcement Learning](/posts/20260516-reflexion/) is one of them — it converts scalar environment feedback into natural-language reflections stored in episodic memory, beating baselines without updating any weights.
    * [GEPA: Reflective Prompt Evolution Can Outperform Reinforcement Learning](/posts/20260513-gepa/) makes the same case head-to-head against an actual RL method — natural-language reflection on sampled trajectories beats GRPO by up to 20% while using 35× fewer rollouts.

* He's skeptical about ["reflective" data loops](#ch-humans-learn) where models train on their own outputs, warning that purely synthetic self-training could collapse into low-entropy, repetitive behavior. True reflection, he notes, is still uniquely human.
    * The empirical case for his skepticism: [Large Language Models Cannot Self-Correct Reasoning Yet](/posts/20260516-cannot-self-correct/) shows that without external feedback, LLMs degrade rather than improve across GSM8K, CommonSenseQA, and HotpotQA.
    * The 3-paper arc that frames the debate end-to-end: [Can LLMs Reliably Self-Correct Their Own Reasoning?](/posts/20260516-llm-self-correction-arc/), with the [Q&A follow-up on whether it still holds for o1/R1-style reasoning models](/posts/20260517-self-correction-after-reasoning-models/).
    * And the partial counter: [SCoRe — training language models to self-correct via RL](/posts/20260512-score/) shows that self-correction *can* be trained in, with the right reward shaping.

* He thinks [**coding LLMs are smart, but not yet reliable collaborators**](#ch-llm-cognitive-deficits). They struggle to reason about a new codebase, or default to boilerplate when nuance matters.
    * Simon Willison reaches a similar place from the practitioner side: [Vibe Coding and Agentic Engineering Are Getting Closer](/posts/20260514-vibe-coding-and-agentic-engineering/). He's stopped reviewing every line of code Claude Code writes, even on production systems, and the line he himself drew between the two modes is blurring.
    * Two related angles on the costs of leaning on coding agents anyway: [Agentic Coding Is a Trap](/posts/20260507-agentic-coding-is-a-trap/) (Lars Faye on the skill-atrophy cost of orchestrator workflows) and [Where Claude Code tokens go](/posts/20260503-where-claude-code-tokens-go/) (the token-spend cost — 73% of Claude Code spend goes to pre-prompt overhead).

<https://www.dwarkesh.com/p/andrej-karpathy>

YouTube chapters (jump to the enriched transcript below, or watch on YouTube):

- [0:00:00 — AGI is still a decade away](#ch-agi-decade-away) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=0s))
- [0:30:33 — LLM cognitive deficits](#ch-llm-cognitive-deficits) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=1833s))
- [0:40:53 — RL is terrible](#ch-rl-is-terrible) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=2453s))
- [0:50:26 — How do humans learn?](#ch-humans-learn) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=3026s))
- [1:07:13 — AGI will blend into 2% GDP growth](#ch-gdp-growth) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=4033s))
- [1:18:24 — ASI](#ch-asi) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=4704s))
- [1:33:38 — Evolution of intelligence & culture](#ch-evolution-culture) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=5618s))
- [1:43:43 — Why self driving took so long](#ch-self-driving) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=6223s))
- [1:57:08 — Future of education](#ch-education) ([YouTube](https://www.youtube.com/watch?v=lXUZvyajciY&t=7028s))

::: {.callout-tip}
**Related.** Sutskever made the precursor call ten months earlier at NeurIPS 2024: [pre-training is over, what comes next is some mix of agents, synthetic data, and inference-time compute](/posts/20241213-sutskever-pretraining-over/). Karpathy's "decade of agents" framing is the natural follow-on.
:::

## Transcript {#transcript}

What's here is [the published transcript on Dwarkesh's site](https://www.dwarkesh.com/p/andrej-karpathy), reorganized into a reader-friendly form. The dialog itself is verbatim — no words added, cut, or reworded — but five layers of editorial structure have been added on top:
...
- **Bracketed acronym expansions.** Where an acronym appears for the first time without being expanded in speech, the expansion is inserted in `[square brackets]` (e.g. `RL [reinforcement learning]`) to mark the addition as editorial.
- **Editor's notes** in blue callout boxes flag claims worth double-checking — paper identifications Karpathy half-recalls, dates that are slightly off, or back-of-envelope numbers worth grounding.
- **Numbered references.** Every paper cited in the body or callouts has a `[[N]](#ref-N)` cite linking to the References block at the bottom of the post.


### [0:00:00 — AGI is still a decade away](https://www.youtube.com/watch?v=lXUZvyajciY&t=0s) {#ch-agi-decade-away}


#### Why "decade of agents," not "year of agents"


**Dwarkesh Patel:** Today I’m speaking with [Andrej Karpathy](https://karpathy.ai/). Andrej, why do you say that this will be the decade of [agents](https://en.wikipedia.org/wiki/Agentic_AI) and not the year of agents?
...
I will say that there have been some papers that I thought were interesting that look at the mechanisms behind in-context learning. I do think it’s possible that in-context learning runs a small gradient descent loop internally in the layers of the neural network. [I recall one paper in particular](https://arxiv.org/abs/2211.15661) [[2]](#ref-2) where they were doing linear regression using in-context learning. Your inputs into the neural network are XY pairs, XY, XY, XY that happen to be on the line. Then you do X and you expect Y. The neural network, when you train it in this way, does [linear regression](https://en.wikipedia.org/wiki/Linear_regression).
...
::: {.callout-note}
**Editor's note.** The paper Karpathy half-recalls (and the one the Dwarkesh transcript editors linked) is [Akyürek et al., *What learning algorithm is in-context learning?*](https://arxiv.org/abs/2211.15661) [[2]](#ref-2) — that paper hand-constructs transformer weights that implement linear-regression gradient descent over in-context (X, Y) pairs, exactly as Karpathy describes. A closely related result, [von Oswald et al., *Transformers learn in-context by gradient descent*](https://arxiv.org/abs/2212.07677) [[3]](#ref-3), makes a similar case from a different angle.
:::
...
**Dwarkesh Patel:** In 10 years, do you think it’ll still be something like a transformer, but with much more modified attention and more sparse [MLPs](https://en.wikipedia.org/wiki/Multilayer_perceptron) and so forth?


**Andrej Karpathy:** The way I like to think about it is [translation invariance](https://en.wikipedia.org/wiki/Translational_symmetry) in time. So 10 years ago, where were we? 2015. In 2015, we had [convolutional neural networks](https://en.wikipedia.org/wiki/Convolutional_neural_network) primarily, [residual networks](https://en.wikipedia.org/wiki/Residual_neural_network) just came out. So remarkably similar, I guess, but quite a bit different still. The transformer was not around. All these more modern tweaks on the transformer were not around. Maybe some of the things that we can bet on, I think in 10 years by translational equivariance, is that we’re still training giant neural networks with a [forward backward pass](https://towardsdatascience.com/neural-networks-forward-pass-and-backpropagation-be3b75a1cfcc/) and update through gradient descent, but maybe it looks a bit different, and it’s just that everything is much bigger.


Recently I went back all the way to 1989 which was a fun exercise for me, a few years ago, because I was reproducing [Yann LeCun’s](https://en.wikipedia.org/wiki/Yann_LeCun) [1989 convolutional network](https://www.ics.uci.edu/~welling/teaching/273ASpring09/lecun-89e.pdf) [[4]](#ref-4), which was [the first neural network](https://en.wikipedia.org/wiki/LeNet) I’m aware of trained via gradient descent, like modern neural network trained gradient descent on digit recognition. I was just interested in how I could modernize this. How much of this is algorithms? How much of this is data? How much of this progress is compute and systems? I was able to very quickly halve the learning just by time traveling by 33 years.
...
**Dwarkesh Patel:** Yeah. I was about to ask you a very similar question about [nanochat](https://x.com/karpathy/status/1977755427569111362). Since you just coded it up recently, every single step in the process of building a chatbot is fresh in your RAM. I’m curious if you had similar thoughts about, “Oh, there was no one thing that was relevant to going from GPT-2 to nanochat.” What are some surprising takeaways from the experience?
...
### [0:30:33 — LLM cognitive deficits](https://www.youtube.com/watch?v=lXUZvyajciY&t=1833s) {#ch-llm-cognitive-deficits}
...
**Dwarkesh Patel:** The reason this question is so interesting is because the main story people have about AI exploding and getting to [superintelligence](https://en.wikipedia.org/wiki/Superintelligence) pretty rapidly is AI automating AI engineering and AI research. They’ll look at the fact that you can have [Claude Code](https://www.claude.com/product/claude-code) and make entire applications, [CRUD](https://en.wikipedia.org/wiki/Create,_read,_update_and_delete) [create-read-update-delete] applications, from scratch and think, “If you had this same capability inside of OpenAI and DeepMind and everything, just imagine a thousand of you or a million of you in parallel, finding little architectural tweaks.”
...
### [0:40:53 — RL is terrible](https://www.youtube.com/watch?v=lXUZvyajciY&t=2453s) {#ch-rl-is-terrible}
...
**Dwarkesh Patel:** You’re basically training the LLM to be a [prompt injection](https://en.wikipedia.org/wiki/Prompt_injection) model.
...
**Dwarkesh Patel:** To the extent you think this is the bottleneck to making RL more functional, then that will require making LLMs better judges, if you want to do this in an automated way. Is it just going to be some sort of [GAN](https://en.wikipedia.org/wiki/Generative_adversarial_network) [generative adversarial network]-like approach where you have to train models to be more robust?
...
**Dwarkesh Patel:** Have you seen this [super interesting paper that dreaming is a way of preventing this](https://www.sciencedirect.com/science/article/pii/S2666389921000945?ref=pdf_download&fr=RR-7&rr=98fc403fefa4f8a7) [[7]](#ref-7) kind of [overfitting](https://aws.amazon.com/what-is/overfitting/) and collapse? The reason dreaming is evolutionary adaptive is to put you in weird situations that are very unlike your day-to-day reality, so as to prevent this kind of overfitting.
...
**Dwarkesh Patel:** What is a solution to model collapse? There are very naive things you could attempt. The distribution over [logits](https://en.wikipedia.org/wiki/Logit) should be wider or something. There are many naive things you could try. What ends up being the problem with the naive approaches?
...
**Dwarkesh Patel:** How many bits should the optimal core of intelligence end up being if you just had to make a guess? The thing we put on the [von Neumann probes](https://en.wikipedia.org/wiki/Self-replicating_spacecraft), how big does it have to be?
...
**Dwarkesh Patel:** Do you expect the low-hanging fruit to be similar in kind to the kinds of things that have been happening over the last two to five years? If I look at nanochat versus [nanoGPT](https://github.com/karpathy/nanoGPT) and the architectural tweaks you made, is that the flavor of things you expect to continue to keep happening? You’re not expecting any giant paradigm shifts.
...
### [1:07:13 — AGI will blend into 2% GDP growth](https://www.youtube.com/watch?v=lXUZvyajciY&t=4033s) {#ch-gdp-growth}
...
We also have a lot of infrastructure pre-built for handling code and text. For example, we have [Visual Studio Code](https://code.visualstudio.com/) or your favorite [IDE](https://en.wikipedia.org/wiki/Integrated_development_environment) [integrated development environment] showing you code, and an agent can plug into that. If an agent has a [diff](https://en.wikipedia.org/wiki/Diff) where it made some change, we suddenly have all this code already that shows all the differences to a code base using a diff. It’s almost like we’ve pre-built a lot of the infrastructure for code.
...
### [1:18:24 — ASI](https://www.youtube.com/watch?v=lXUZvyajciY&t=4704s) {#ch-asi}


#### Superintelligence as continued automation


**Dwarkesh Patel:** How do you think about [superintelligence](https://en.wikipedia.org/wiki/Superintelligence)? Do you expect it to feel qualitatively different from normal humans or human companies?
...
### [1:33:38 — Evolution of intelligence & culture](https://www.youtube.com/watch?v=lXUZvyajciY&t=5618s) {#ch-evolution-culture}


#### Was intelligence a rare event? Bacteria → eukaryote → animals timescales


**Dwarkesh Patel:** You recommended [Nick Lane’s](https://www.dwarkesh.com/p/nick-lane) [book](https://amzn.to/42KeI4w) to me. On that basis, I also found it super interesting and I interviewed him. I have some questions about thinking about intelligence and evolutionary history.
...
We got to squirrel intelligence right after the [Cambrian explosion](https://en.wikipedia.org/wiki/Cambrian_explosion) 600 million years ago. It seems like what instigated that was the [oxygenation event](https://en.wikipedia.org/wiki/Great_Oxidation_Event) 600 million years ago. But immediately the intelligence algorithm was there to make the squirrel intelligence. It’s suggestive that animal intelligence was like *that*. As soon as you had the oxygen in the environment, you had the eukaryote, you could just get the algorithm. Maybe it was an accident that evolution stumbled upon it so fast, but I don’t know if that suggests that at the end it’s going to be quite simple.
...
::: {.callout-note}
**Editor's note.** Quintin Pope's argument is laid out in [*Evolution provides no evidence for the sharp left turn*](https://www.lesswrong.com/posts/hvz9qjWyv8cLX9JJR/evolution-provides-no-evidence-for-the-sharp-left-turn) (LessWrong, 2023). The transcript editors link the Open Philanthropy PDF mirror; the LessWrong original has the live comment thread.
:::
...
**Dwarkesh Patel:** Interesting. When would you expect that kind of thing to start happening? Also, [multi-agent systems](https://en.wikipedia.org/wiki/Multi-agent_system) and a sort of independent AI civilization and culture?
...
### [1:43:43 — Why self driving took so long](https://www.youtube.com/watch?v=lXUZvyajciY&t=6223s) {#ch-self-driving}
...
::: {.callout-note}
**Editor's note.** The "CMU 1986" demo is [Navlab 1](https://en.wikipedia.org/wiki/Navlab), Carnegie Mellon's first autonomous van, which drove itself on roads at low speeds starting in 1986. The often-cited "first highway-speed self-driving" is Ernst Dickmanns's [VaMoRs](https://en.wikipedia.org/wiki/VaMoRs) at Bundeswehr University Munich, also demonstrated in 1986–1987.
:::
...
#### Coding shares the safety property of self-driving


**Dwarkesh Patel:** It’s very interesting to hear you say that, that the safety guarantees you need from software are not dissimilar to self-driving. What people will often say is that self-driving took so long because the cost of failure is so high. A human makes a mistake on average every 400,000 miles or every seven years. If you had to release a coding agent that couldn’t make a mistake for at least seven years, it would be much harder to deploy.


But your point is that if you made a catastrophic coding mistake, like breaking some important system every seven years...


**Andrej Karpathy:** Very easy to do.


**Dwarkesh Patel:** In fact, in terms of wall clock time, it would be much less than seven years because you’re constantly outputting code like that. In terms of tokens, it would be seven years. But in terms of wall clock time...


**Andrej Karpathy:** In some ways, it’s a much harder problem. Self-driving is just one of thousands of things that people do. It’s almost like a single vertical, I suppose. Whereas when we’re talking about general software engineering, it’s even more... There’s more surface area.
...
**Andrej Karpathy:** Kind of like what happened with [railroads](https://www.focus-economics.com/blog/railway-mania-the-largest-speculative-bubble-you-never-heard-of/).
...
**Andrej Karpathy:** Yeah. There’s historical precedent. Or was it with the telecommunication industry? Pre-paving the internet that only came a decade later and creating a [whole bubble in the telecommunications industry](https://www.fabricatedknowledge.com/p/lessons-from-history-the-rise-and) in the late ‘90s.
...
### [1:57:08 — Future of education](https://www.youtube.com/watch?v=lXUZvyajciY&t=7028s) {#ch-education}


#### Why Eureka, not another lab — protecting humanity from disempowerment


**Dwarkesh Patel:** Let’s talk about education and [Eureka](https://eurekalabs.ai/). One thing you could do is start another AI lab and then try to solve those problems. I’m curious what you’re up to now, and why not AI research itself?
...
**Andrej Karpathy:** The easiest way I can describe it is we’re trying to build the [Starfleet Academy](https://memory-alpha.fandom.com/wiki/Starfleet_Academy). I don’t know if you’ve watched *Star Trek*.
...
**Dwarkesh Patel:** It also makes the learning experience so much more motivated. Your tutorial on the transformer begins with [bigrams](https://en.wikipedia.org/wiki/Bigram), literally a lookup table from, “Here’s the word right now, or here’s the previous word, here’s the next word.” It’s literally just a lookup table.
...
#### Curse of knowledge; share dumb ChatGPT conversations


**Dwarkesh Patel:** Because if you try to come up with it yourself, you get a better understanding of what the action space is, what the objective is, and then why only this action fulfills that objective.


**Andrej Karpathy:** You have a chance to try it yourself, and you have an appreciation when I give you the solution. It maximizes the amount of knowledge per new fact added.


**Dwarkesh Patel:** Why do you think, by default, people who are genuine experts in their field are often bad at explaining it to somebody ramping up?


**Andrej Karpathy:** It’s the [curse of knowledge](https://en.wikipedia.org/wiki/Curse_of_knowledge) and expertise. This is a real phenomenon, and I suffered from it myself as much as I try not to. But you take certain things for granted, and you can’t put yourself in the shoes of new people who are just starting out. This is pervasive and happens to me as well.
...
- [Dwarkesh Podcast — "Andrej Karpathy — AGI is still a decade away"](https://www.dwarkesh.com/p/andrej-karpathy) (full transcript)
- [YouTube video](https://www.youtube.com/watch?v=lXUZvyajciY) (2h 26m, Oct 17, 2025)

**People**

- [Andrej Karpathy](https://karpathy.ai/) — co-founder OpenAI, former Sr. Director of AI at Tesla, founder of [Eureka Labs](https://eurekalabs.ai/); as of [May 19, 2026, joined Anthropic](https://www.forbes.com/sites/aliciapark/2026/05/19/openai-cofounder-and-former-tesla-ai-leader-andrej-karpathy-joins-anthropic/)
- [Dwarkesh Patel](https://www.dwarkesh.com/) — host of the *Dwarkesh Podcast*
- [Geoffrey Hinton](https://en.wikipedia.org/wiki/Geoffrey_Hinton) — University of Toronto, "godfather of AI"
- [Yann LeCun](https://en.wikipedia.org/wiki/Yann_LeCun) — Meta Chief AI Scientist, author of the 1989 paper Karpathy reproduced
- [Richard Sutton](https://www.dwarkesh.com/p/richard-sutton) — RL pioneer; Karpathy's "we want to build animals" foil
- [Nick Lane](https://www.dwarkesh.com/p/nick-lane) — UCL biochemist whose books frame the chapter on the evolution of intelligence
- [Quintin Pope](https://www.alignmentforum.org/users/quintin-pope) — author of the LessWrong post on humans not having had a sharp left turn
- [Gwern Branwen](https://www.dwarkesh.com/p/gwern-branwen) and [Carl Shulman](https://www.dwarkesh.com/p/carl-shulman) — Dwarkesh Podcast guests cited on the niche-and-scalable-brain argument
- [Andy Matuschak](https://www.dwarkesh.com/p/andy-matuschak) — Dwarkesh Podcast guest, mentioned on spaced-repetition prompt-writing experiments
- [Sal Khan](https://en.wikipedia.org/wiki/Sal_Khan) — [Khan Academy](http://khanacademy.org/) founder
- [Geoffrey West](https://en.wikipedia.org/wiki/Geoffrey_West) — Santa Fe Institute physicist, author of *[Scale](https://amzn.to/47ilBeP)*
- [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) — origin of the "what I cannot create, I do not understand" quote

**Concepts and background**

- [Agentic AI](https://en.wikipedia.org/wiki/Agentic_AI), [agents and the autonomy slider](https://a16z.com/the-rise-of-computer-use-and-agentic-coworkers/)
- [Large language models](https://en.wikipedia.org/wiki/Large_language_model), [pre-training](https://en.wikipedia.org/wiki/Generative_pre-trained_transformer), [in-context learning](https://www.hopsworks.ai/dictionary/in-context-learning-icl), [KV cache](https://huggingface.co/blog/not-lain/kv-caching)
- [Continual learning](https://en.wikipedia.org/wiki/Incremental_learning), [model collapse](https://en.wikipedia.org/wiki/Model_collapse), [synthetic data](https://en.wikipedia.org/wiki/Synthetic_data), [overfitting](https://aws.amazon.com/what-is/overfitting/)
- [Reinforcement learning](https://en.wikipedia.org/wiki/Reinforcement_learning), [imitation learning](https://en.wikipedia.org/wiki/Imitation_learning), [process supervision](https://openai.com/index/improving-mathematical-reasoning-with-process-supervision/), [reward functions](https://stats.stackexchange.com/questions/189067/how-to-make-a-reward-function-in-reinforcement-learning), [GANs](https://en.wikipedia.org/wiki/Generative_adversarial_network), [hill climbing](https://en.wikipedia.org/wiki/Hill_climbing), [self-play](https://en.wikipedia.org/wiki/Self-play)
- [Transformer](https://en.wikipedia.org/wiki/Transformer_(deep_learning_architecture)) architecture, [convolutional networks](https://en.wikipedia.org/wiki/Convolutional_neural_network), [residual networks](https://en.wikipedia.org/wiki/Residual_neural_network), [LeNet](https://en.wikipedia.org/wiki/LeNet), [MLPs](https://en.wikipedia.org/wiki/Multilayer_perceptron), [LoRA](https://www.ibm.com/think/topics/lora), [sparse attention](https://medium.com/@vishal09vns/sparse-attention-dad17691478c)
- [Gradient descent](https://en.wikipedia.org/wiki/Gradient_descent), [forward-backward pass](https://towardsdatascience.com/neural-networks-forward-pass-and-backpropagation-be3b75a1cfcc/), [tensors](https://en.wikipedia.org/wiki/Tensor_(machine_learning)), [chain rule](https://en.wikipedia.org/wiki/Chain_rule), [linear regression](https://en.wikipedia.org/wiki/Linear_regression)
- [AGI](https://en.wikipedia.org/wiki/Artificial_general_intelligence), [superintelligence](https://en.wikipedia.org/wiki/Superintelligence) (ASI), [AI 2027](https://ai-2027.com/)
- [Cambrian explosion](https://en.wikipedia.org/wiki/Cambrian_explosion), [Great Oxidation Event](https://en.wikipedia.org/wiki/Great_Oxidation_Event), [Industrial Revolution](https://en.wikipedia.org/wiki/Industrial_Revolution), [Neolithic Revolution](https://en.wikipedia.org/wiki/Neolithic_Revolution)
- [March of nines](https://en.wikipedia.org/wiki/High_availability#%22Nines%22), [curse of knowledge](https://en.wikipedia.org/wiki/Curse_of_knowledge), [vibe coding](https://en.wikipedia.org/wiki/Vibe_coding), [steelmanning](https://en.wikipedia.org/wiki/Straw_man#Steelmanning)

**Companies and products**

- [OpenAI](https://en.wikipedia.org/wiki/OpenAI) — [Codex](https://en.wikipedia.org/wiki/OpenAI_Codex), [GPT-4.5](https://openai.com/index/introducing-gpt-4-5/), [GPT-5 Pro](https://platform.openai.com/docs/models/gpt-5-pro), [gpt-oss-20b](https://openai.com/index/introducing-gpt-oss/), the [Universe project](https://openai.com/index/universe/) Karpathy worked on
- [Anthropic](https://www.anthropic.com/) — Claude, [Claude Code](https://www.claude.com/product/claude-code)
- [Meta — Llama 3](https://www.llama.com/models/llama-3/)
- [DeepSeek v3.2](https://api-docs.deepseek.com/news/news250929)
- [Tesla](https://www.tesla.com/) — [Robotaxi](https://www.tesla.com/robotaxi); [Waymo](https://en.wikipedia.org/wiki/Waymo)
- [Google DeepMind — AlphaGo](https://en.wikipedia.org/wiki/AlphaGo)
- [Microsoft — Visual Studio Code](https://code.visualstudio.com/)
- [Eureka Labs](https://eurekalabs.ai/) — Karpathy's education startup; [LLM101N](https://github.com/karpathy/LLM101n) course
- [nanochat](https://github.com/karpathy/nanochat), [nanoGPT](https://github.com/karpathy/nanoGPT), [micrograd](https://github.com/karpathy/micrograd) — Karpathy's teaching repos
- [Khan Academy](http://khanacademy.org/), [CS231n at Stanford](https://cs231n.stanford.edu/)
- [PyTorch](https://en.wikipedia.org/wiki/PyTorch) — [DistributedDataParallel](https://docs.pytorch.org/tutorials/intermediate/ddp_tutorial.html); [Rust](https://en.wikipedia.org/wiki/Rust_(programming_language))
- [Nvidia — Tensor Cores](https://www.nvidia.com/en-us/data-center/tensor-cores/), [GPU evolution](https://newsletter.semianalysis.com/p/nvidia-tensor-core-evolution-from-volta-to-blackwell)

**Papers and technical reports**

1. <a id="ref-1"></a>Mnih, Volodymyr, Koray Kavukcuoglu, David Silver, Alex Graves, Ioannis Antonoglou, Daan Wierstra, and Martin Riedmiller. "Playing Atari with Deep Reinforcement Learning." *NIPS Deep Learning Workshop* (arXiv:1312.5602), 2013. <https://arxiv.org/abs/1312.5602>. The follow-up *Nature* 2015 paper extended the method and is what most people now associate with DQN.
2. <a id="ref-2"></a>Akyürek, Ekin, Dale Schuurmans, Jacob Andreas, Tengyu Ma, and Denny Zhou. "What learning algorithm is in-context learning? Investigations with linear models." *ICLR* (arXiv:2211.15661), 2023. <https://arxiv.org/abs/2211.15661>. Hand-constructs transformer weights that implement gradient descent on linear regression over in-context (X, Y) pairs — the paper Karpathy describes recalling.
3. <a id="ref-3"></a>von Oswald, Johannes, Eyvind Niklasson, Ettore Randazzo, João Sacramento, Alexander Mordvintsev, Andrey Zhmoginov, and Max Vladymyrov. "Transformers learn in-context by gradient descent." *ICML* (arXiv:2212.07677), 2023. <https://arxiv.org/abs/2212.07677>. Closely related result reaching the same conclusion from a different angle.
4. <a id="ref-4"></a>LeCun, Yann, Bernhard Boser, John S. Denker, Donnie Henderson, R. E. Howard, Wayne Hubbard, and Lawrence D. Jackel. "Backpropagation Applied to Handwritten Zip Code Recognition." *Neural Computation* 1, no. 4 (1989): 541–551. <https://www.ics.uci.edu/~welling/teaching/273ASpring09/lecun-89e.pdf>. The convolutional network Karpathy reproduced 33 years later in his 2022 write-up.
5. <a id="ref-5"></a>Ouyang, Long, Jeff Wu, Xu Jiang, Diogo Almeida, Carroll L. Wainwright, Pamela Mishkin, Chong Zhang, et al. "Training language models to follow instructions with human feedback." *NeurIPS* (arXiv:2203.02155), 2022. <https://arxiv.org/abs/2203.02155>. The InstructGPT paper.
6. <a id="ref-6"></a>Ouyang, Siru, Jun Yan, I-Hung Hsu, Yanfei Chen, Ke Jiang, Zifeng Wang, Rujun Han, Long T. Le, Samira Daruki, Xiangru Tang, Vishy Tirumalashetty, George Lee, Mahsan Rofouei, Hangfei Lin, Jiawei Han, Chen-Yu Lee, and Tomas Pfister. "ReasoningBank: Scaling Agent Self-Evolving with Reasoning Memory." *arXiv preprint* (arXiv:2509.25140), September 29, 2025. <https://arxiv.org/abs/2509.25140>. A Google memory framework where an LLM agent distills strategies from past interactions into a "reasoning memory" — the closest match to the "memory bank paper from Google" Karpathy half-recalls.
7. <a id="ref-7"></a>Hoel, Erik. "The overfitted brain: Dreams evolved to assist generalization." *Patterns* 2, no. 5 (2021): 100244. <https://www.sciencedirect.com/science/article/pii/S2666389921000945>. Argues that dreams act as adversarial examples that prevent overfitting in the waking brain — the paper Dwarkesh asks Karpathy about.
