...
- [A Rube Goldberg Pipeline for Sharing Links](/posts/20260420-rube-goldberg-publishing/): the build pipeline from the authoring side, where this post takes up the CI render and caching machinery that pipeline feeds into.
- [A User Manual for *synesis*](/posts/20260508-site-user-manual/): the reader-facing payoff of the read-side work here, documenting the features whose page-weight cost this post bounds.
- [Making *synesis* Agent-Friendly](/posts/20260508-making-the-blog-agent-friendly/): the machine-readable surfaces (post-index.json among them) that this post lifts out of per-page HTML to keep the render incremental.
