...
![](cover.jpg){data-lightbox-src="cover-full.jpg"}
...
![Figure from [the paper](http://arxiv.org/abs/2305.14825).](fig3.jpg){data-lightbox-src="fig3-full.jpg"}
...
1. <a id="ref-1"></a>Xiaojuan Tang, Zilong Zheng, Jiaqi Li, Fanxu Meng, Song-Chun Zhu, Yitao Liang, and Muhan Zhang. 2023. "Large Language Models are In-Context Semantic Reasoners rather than Symbolic Reasoners." <http://arxiv.org/abs/2305.14825>
2. <a id="ref-2"></a>Antonio Valerio Miceli-Barone, Fazl Barez, Ioannis Konstas, and Shay B. Cohen. 2023. "The Larger They Are, the Harder They Fail: Language Models do not Recognize Identifier Swaps in Python." <http://arxiv.org/abs/2305.15507>
3. <a id="ref-3"></a>Emre Kıcıman, Robert Ness, Amit Sharma, and Chenhao Tan. 2023. "Causal Reasoning and Large Language Models: Opening a New Frontier for Causality." <http://arxiv.org/abs/2305.00050>
4. <a id="ref-4"></a>Zhijing Jin, Jiarui Liu, Zhiheng Lyu, Spencer Poff, Mrinmaya Sachan, Rada Mihalcea, Mona Diab, and Bernhard Schölkopf. 2023. "Can Large Language Models Infer Causation from Correlation?" <http://arxiv.org/abs/2306.05836>
