...
![Screenshot of the first toot in Terence Tao's three-part thread. Image from [Mastodon](https://mathstodon.xyz/@tao/116450581967483825).](cover.jpg){fig-align="center" data-lightbox-src="cover-full.jpg"}
...
- [Civilization's Three Stages, Applied to Mathematics](/posts/20260421-civilizations-three-stages/): Tao's companion post from the day before, where this same generation-to-digestion shift is framed as math's move from scarcity to abundance.
- [An OpenAI Model Disproves a Discrete-Geometry Conjecture](/posts/20260606-model-disproves-discrete-geometry-conjecture/): a concrete case of a machine-produced result arriving generated and verified but barely digested, the exact mismatch Tao warns about.
- [When Computers Write Proofs, What's the Point of Mathematicians?](/posts/20230902-computers-write-proofs/): the earlier version of the worry, when the question was whether machine proofs leave anything for humans to understand.
- [The Leiden Declaration on AI and Mathematics](/posts/20260602-leiden-declaration-ai-mathematics/): the field's attempt to set norms for the incentive problem Tao names, rewarding the first to solve over the one who explains.
