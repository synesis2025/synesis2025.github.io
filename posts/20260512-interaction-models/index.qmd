...
- [The Inference Shift](/posts/20260511-the-inference-shift/): the same human-waits vs. no-human-waits split, applied to the hardware stack rather than to training objectives and model families.
- [Pointing for AI](/posts/20260512-pointing-for-ai/): the same chat-box bottleneck attacked from the input side, letting humans gesture at what they mean instead of training interactivity into the model.
- [Mira Murati on Interaction Models and Keeping Humans in the Loop](/posts/20260605-interaction-model-interviews/): the founder's own framing a month on, casting interaction models as the lab's human-in-the-loop bet against the autonomy-first path.
- [The 2028 Global Intelligence Crisis: Scenario and Rebuttal](/posts/20260502-2028-intelligence-crisis/): the substitute-vs-augment debate this post recasts as a UX problem rather than a capability fact.
