...
Evaluation uses both simulated readers (LMs conditioned on the generation) and real human readers, and factuality is scored at the claim level with a retrieval plus large-language-model (LLM) verifier pipeline in the style of [FActScore](https://arxiv.org/abs/2305.14251) [[3]](#ref-3).
